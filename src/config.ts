...
const PROJECT_CONFIG_FILES = [".opencode/context-routing.json", ".opencode/context-routing.jsonc"];
const USER_CONFIG_FILES = [
  join(USER_CONFIG_DIR, "context-routing.json"),
  join(USER_CONFIG_DIR, "context-routing.jsonc"),
  join(USER_CONFIG_DIR, "plugins", "context-routing", "context-routing.json"),
  join(USER_CONFIG_DIR, "plugins", "context-routing", "context-routing.jsonc"),
];
