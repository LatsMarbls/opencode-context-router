...
**OpenCode plugin — inject the right skill at the right time, without blowing your token budget.**

4-dimension trigger engine · static-file backend · priority budget · compaction survival
